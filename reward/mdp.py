...
class MDP:
    def __init__(self, transition_probability, transition_beta, env_features, reward_weights, gamma, start=None, goal = None, terminal=None, max_value=1000000):
        self.n_states,self.d_states = env_features.size()
        _,self.n_action,_ = transition_probability.size()
        self.env_features = env_features
        self.transitions = transition_probability
        ...
        #self.gt_tpweights = transition_probability
